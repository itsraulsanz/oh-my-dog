  ...
  render() {
    ...
    return (
      <Layout>
        ...
        <TextBanner id="trips" color="orange" pdfCalendar={pdfCalendar} descriptionText1={intl.formatMessage({ id: "trips.description1" })} descriptionText2={intl.formatMessage({ id: "trips.description2" })} buttonText={intl.formatMessage({ id: "trips.button-text" })} year={currentYear} />
