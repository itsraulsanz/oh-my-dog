  ...
  render() {
    ...
    return (
      <Layout>
        ...
        /> */}
        <Reviews color="#ffffff" padding="padding" reviews={reviews} rating={reviewsData.rating} userRating={reviewsData.userRating} subHeadingText={intl.formatMessage({ id: "reviews.title" })} reviewsText={intl.formatMessage({ id: "reviews.reviewsText" })} />
        ...
        <BlogList color="#FCEEDD" padding="padding-top" posts={postsData} subheadingText={intl.formatMessage({ id: "blog.title" })} descriptionText={intl.formatMessage({ id: "blog.description" })} link={intl.formatMessage({ id: "blog.title" })} />
