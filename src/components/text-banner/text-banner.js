...
export default function TextBanner({id, color, headingText, year, descriptionText1, descriptionText2, pdf, buttonText, pdfCalendar}) {
  console.log('pdfCalendar', pdfCalendar)
