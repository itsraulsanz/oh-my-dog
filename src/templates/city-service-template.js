...
class CityTemplate extends React.Component {
  render() {
    ...
    console.log('serviceSlugTranslationTEST', serviceSlugTranslation);
    ...
    return (
      <Layout location={this.props.location}>
        ...
        />
        <div className="city-service-template container-fluid">
...
export const pageQuery = graphql`
  query CityQuery(
    ...
    allContentfulBanner(sort: { fields: orderId, order: ASC } filter: { section: { eq: $serviceSlug }, node_locale: { eq: $language } }) {
      nodes {
        section
        title
        image {
